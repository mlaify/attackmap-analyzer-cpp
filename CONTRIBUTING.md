# Contributing to `attackmap-analyzer-cpp`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-cpp.git
cd attackmap-analyzer-cpp
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-cpp/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-cpp/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-cpp`, you agree that your contributions will be
